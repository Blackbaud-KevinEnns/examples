 ...
 * <p>
 * 1) Start Zookeeper and Kafka. Please refer to <a href='http://docs.confluent.io/3.0.0/quickstart.html#quickstart'>CP3.0.0 QuickStart</a>.
 * <p>
 ...
 *                    --zookeeper localhost:2181 --partitions 1 --replication-factor 1
 * }</pre>
 * Note: The above commands are for CP 3.0.0 only. For Apache Kafka it should be {@code bin/kafka-topics.sh ...}.
 * <p>
